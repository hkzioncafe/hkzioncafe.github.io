...
function getNavHtml() {
  ...
  html += '      <img src="img/icon.png" width="32" height="32" alt="">  ';
...
*/
  ...
  html += '      <button class="btn btn-warning my-2 my-sm-0"><i class="fa fa-qrcode" style="font-size:32px;" onclick="return createUserQrView();"></i></button>';
  // html += '    </form>';
  html += '    </div>';
